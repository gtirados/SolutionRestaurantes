       ...
       ' gMozo = Me.lblMozo.Tag
        ...
        Do While Not oRsComanda.EOF
            ...
            With Me.lvPlatos.ListItems.Add(, , Trim(oRsComanda!plato), Me.ilComanda.ListImages(1).key, Me.ilComanda.ListImages(1).key)
                ...
                vICBPER = vICBPER + oRsComanda!icbper
...
Private Sub cmdCantidad_Click()
    ...
    End If
        ...
        If Me.lvPlatos.SelectedItem.SubItems(9) = 1 Or Me.lvPlatos.SelectedItem.SubItems(7) <> 0 Or Me.lvPlatos.SelectedItem.SubItems(11) = 1 Then
            ...
            For Each crParamDef In crParamDefs
                ...
                Select Case crParamDef.ParameterFieldName
                    ...
                    Case "mesa"
                        ...
                        Case "p_icbper"
                        crParamDef.AddCurrentValue vICBPER
